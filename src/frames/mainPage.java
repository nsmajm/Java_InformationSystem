...
public class mainPage{
	    ...
	    JButton searchButton,loginButton,registraionbutton,userName,nameButton;
		...
		public mainPage(String guestName)
		{
			this.name =guestName;
			...
			registraionbutton = new JButton("Registration");
		...
		public void addToPanel()
		{
			...
			searchPanel.add(categoryField);
			headerpanel.add(registraionbutton);
		...
		public void setBounds()
		{
			...
			nameButton.setBounds(600, 10, 150, 30);	
			loginButton.setBounds(550, 50, 100, 30);
			registraionbutton.setBounds(650, 50, 105, 30);
		...
		public void setColor()
		{
			...
			loginButton.setBackground(new Color(244, 93, 114));
			registraionbutton.setBackground(new Color(255, 217, 114));
		...
		public void event()
		{
			...
			registraionbutton.addActionListener(new ActionListener() {
			...
			nameButton.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					JOptionPane.showMessageDialog(null, "Sorry You can Not Access this Option..Please Login For Access");
